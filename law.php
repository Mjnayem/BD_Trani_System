  ...
  <div class="panel-wrapper">
    ...
    <div class="right-colum">
      <div class="title">
        ...
        <h1 id="divission">আইন বিধি-বিধান ও নীতিমালা </h1>
      </div>
      <div class="content">
          
        <p>
         <a href="mete_reader_grate_2.php?filename=railwayact.pdf"id="ticket_link">আইন বিধি-বিধান ও নীতিমালা 1</a><br/>
            <a href="mete_reader_grate_2.php?filename=Form-A (1).pdf"id="ticket_link">আইন বিধি-বিধান ও নীতিমালা 2</a><br/>
          </p>
      </div>
    </div>
    <div class="clearing"></div>
