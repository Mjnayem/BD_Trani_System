...
<div class="menu-wrapper">
  <div class="menu">
    <ul>
      ...
      <li><a href="works.php"id="ticket_link">টিকিটের মূল্য</a></li>
  ...
  <div class="panel-wrapper">
    ...
    <div class="right-colum">
      <div class="title">
        ...
        <h1 id="divission">ট্রেন বন্ধের তালিকা </h1>
      </div>
      <div class="content">
...
mysql_query("SET NAMES utf8");
      ...
      $run=mysql_query("select * from off_day");
...
?>
        ...
        এই লিঙ্ক এ যান  <a href="http://www.railway.gov.bd/">ট্রেন বন্ধের তালিকা</a>
