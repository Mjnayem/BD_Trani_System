  ...
  <div class="panel-wrapper">
    ...
    <div class="right-colum">
      <div class="title">
        ...
        <h1 id="divission">টার্মিনাল এর নাম এবং যাত্রার সময়  </h1>
      </div>
      <div class="content">
...
mysql_query("SET NAMES utf8");
      ...
      $run=mysql_query("select * from tarminal_start");
...
?>
        ...
        এই লিঙ্ক এ যান  <a href="http://www.railway.gov.bd/">টার্মিনাল এর নাম এবং যাত্রার সময় </a>
...
<div class="footer-wrapper">
  <div class="footer">
   <p> ©Devalop by shihab 2017.--<a href="https://mail.google.com/mail/u/0/#inbox"> Email: shihab00072@gamil</a> Images From: --<a href="http//google,com">google.com</a> </p>
  </div>
</div>
</body>
</html>
