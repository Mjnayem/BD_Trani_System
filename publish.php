...
<div class="container">
  <div class="panel-wrapper">
        ...
        <div class="content">
          ...
          <div class="right-panel">
            <ul>
              ...
              <li class="borderNone"id="ticket_link"><a href="train_all.php"id="ticket_link">যাত্রীবাহী ট্রেন</a></li>
            </ul>
          </div>
        </div>
      </div>
    ...
    <div class="right-colum">
      <div class="title">
      <h1 id="divission">
প্রকাশ ও প্রচারনা   </h1>
      </div>
      <div class="content">
     <p>
          <a href="publish_1.php?filename=01(1).pdf"id="ticket_link"> সভার বিজ্ঞপ্তি</a><br/>
          <a href="publish_1.php?filename=04.pdf"id="ticket_link"> স্ব-প্রণোদিত তথ্য প্রকাশ নির্দেশিকা </a><br/>
