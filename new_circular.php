  ...
  <div class="panel-wrapper">
    ...
    <div class="right-colum">
     ...
     <p>
        ...
        <a href="mete_reader_grate_2.php?filename=Meter Reader_2.pdf"id="ticket_link">মিটার রিডার গ্রেড-২ পদে নিয়োগ বিজ্ঞপ্তি</a><br/>
         
          <a href="mete_reader_grate_2.php?filename=Mother.pdf"id="ticket_link"> মাতৃভাষা শিক্ষক পদে নিয়োগ বিজ্ঞপ্তি </a><br/>
         
          <a href="mete_reader_grate_2.php?filename=Chain man.pdf"id="ticket_link">চেইন ম্যান পদে নিয়োগ বিজ্ঞপ্তিতি</a><br/>
         
          <a href="mete_reader_grate_2.php?filename=Advertisement of cpow31.pdf"id="ticket_link"> ল্যাব সহকারী পদে নিয়োগ বিজ্ঞপ্তি</a><br/>
         
          <a href="mete_reader_grate_2.php?filename=Store munsi+Tracer+Time Keeper.pdf"id="ticket_link">টাইম কিপার, ষ্টোর মুন্সি এবং ট্রেসার পদে নিয়োগ বিজ্ঞপ্তি</a><br/>
