...
<div class="container">
  <div class="panel-wrapper">
      ...
      <div class="panel">
        ...
        <div class="content">
          ...
          <div class="right-panel">
            <ul>
              <li><a href="visit.php"> রেলপথ পরিদর্শন অধিদপ্তর  সিটিজেন চার্টার</a></li>
    ...
    <div class="right-colum">
      <div class="title">
        <h1>বাংলাদেশ রেলওয়ের সংক্ষিপ্ত ইতিহাস</h1>
      </div>
      <div class="content">
        <h1>নোটিশ বোর্ড</h1>
           <li><a href=" নবনিয়োগ.php ">নবনিয়োগ </a></li>
        </div>
		 <li><a href="#">নবনিয়োগ এর কোটা গণনাকরণ পদ্ধতি </a></li>
		  <li><a href="#">অল ক্যাডার পিএমআইএস</a></li>
		  <li><a href="#">তথ্য অধিকার </a></li>
		   <li><a href="#">প্রকাশ ও প্রচারনা </a></li>
      </div>
    </div>
    <div class="clearing"></div>
  </div>
